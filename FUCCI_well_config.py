...
cutoff: pixel length of the desired square crop
nuc_margin: pixel margin around the nucleus after the crop (sometimes the nucleus will be outside the crop, 
